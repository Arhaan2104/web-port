...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      overview: {
        headline: 'EHR I co-founded and shipped — scratchpad-to-note AI pipeline, patient charts, billing, and messaging for private-pay behavioral health',
        problem: 'Clinicians think in fragments during sessions — quick observations, keywords, partial thoughts. But EHRs expect polished, structured notes afterward. There\'s a gap between how information is captured and how it needs to be recorded.',
        solution: 'A scratchpad-to-note pipeline. Clinicians jot fragments during sessions, then AI structures them into clinical notes (SOAP, DAP, Progress). They review and edit before saving — the AI assists, it doesn\'t replace. The rest is a full patient management platform: charts, treatment plans, billing, and messaging.',
        outcomes: [
          { metric: 'Shipped', description: 'live product used daily by 2 design partners' },
          { metric: 'Techstars', description: 'USC x Techstars Founder Catalyst program' },
          { metric: 'Full stack', description: 'designed and built the frontend end-to-end' },
          { metric: 'HIPAA', description: 'compliant architecture on AWS' },
        ],
        tools: ['React', 'TypeScript', 'Tailwind CSS', 'Zustand', 'React Query', 'Claude API', 'AWS'],
        role: 'Co-founder — Product Design & Engineering',
